/*
 ...
 //$('#asdasd').children().unwrap();

 } else{
 //var contents = $('body').contents();
 //console.log(contents);
 //var $aa = $('body').wrapInner('<div id="asdasd"></div>');
 $('#slidemenu').before('<div class="slide-nav-backdrop"></div>');
 }
 //pagewrapper = $('#asdasd').css('position','relative');
