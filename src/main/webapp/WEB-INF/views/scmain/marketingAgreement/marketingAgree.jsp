...
<meta property="og:url" content="https://spacecloud.kr/member/marketingAgree" />
...
<header class="header header_sub">
    ...
    <div class="page_title"><h2>마케팅 수신 동의 관리</h2></div>
...
<aside id="all_menu" class="drawer" role="navigation">
	...
	<div class="center_wrap account_wrap">
		<div class="center">
			<form id="_marketingAgreementForm">
			<h3 class="tit">마케팅 정보 수신 동의</h3>
			...
			<p class="p_guide normal">
				...
				동의하지 않을 경우 뉴스레터, 이벤트, 특별 혜택 등의 알림을 받아보실 수 없습니다.
			</p>
			<p class="p_guide normal">
				<i class="sp_icon ico_alert"></i>
			...
			<div class="btns">
				<a href="javascript:void(0);" class="btn btn_full btn_default" id="_saveMarketingAgree">완료</a>
			</div>
			</form>
		</div>
	</div>
