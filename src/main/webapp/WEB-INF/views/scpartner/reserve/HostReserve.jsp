...
<div class="wrap">
	<header class="header">
		<div class="page_title"><h2>예약 관리 리스트</h2></div>
...
<aside id="all_menu" role="navigation">
	...
	<!-- contents -->
	<section id="contents" class="contents reservation" role="main">
		<div class="reservation_list">
					...
					<div class="one_search">
						<div class="flex_wrap">
							<div class="flex_box">
								...
								<div class="flex">
									<div class="input">
										<input type="text" name="filter" id="search_reserve_filter" placeholder="예약번호 또는 예약자명" value="" data-ui-sync-param="reserveList" data-ui-enter-click="#search_reserve_btn">
									</div>
								</div>
								<div class="flex">
									<a href="javascript:void(0);" id="search_reserve_btn" class="btn btn_default" data-ui-param-link="reserveList"><i class="sp_icon ico_search_primary"></i><i class="sp_icon ico_btn_search"></i>검색</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="filter_area">
				<div class="inner_width">
					...
					<div class="sorting_filter">
						...
						<select name="status" id="sorting" data-ui-param-link="reserveList" data-ui-sync-label>
							<option value="">전체상태</option>
							
							<option value="RSREQ" >예약 승인 대기</option>
							
							<option value="RSCFM" >결제 대기</option>
							
							<option value="RSCMP" >예약 확정</option>
							
							<option value="RCCMP" >취소·환불</option>
							
							<option value="CHGAF" >예약 변경</option>
							
							<option value="USEDC" >이용 완료</option>
			...
			<div class="list_box_wrap">
				...
				<div class="list_box_wrap no_data">
...
<![endif]-->
<script src="https://ssl.pstatic.net/spacecloud/static/center/js/deploy/20180129075647/min/reserve_min.js" type="text/javascript"></script>
