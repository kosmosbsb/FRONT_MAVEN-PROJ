...
<script type="text/javascript" src="/inc/user/js/join_kr.js?abc"></script>
...
<!-- 스킵네비게이션 : 웹접근성대응-->
	...
	<div id="header">
		...
		<div class="lang">
			<select id="langSelect" name="langSelect" title="언어선택" onChange="changeLang()" class="sel">				
	...
	<div id="container">
		<!-- content -->
		<div id="content">
			<h2 class="blind">네이버 회원가입 완료</h2>
			<div class="join_content">

<form name="join_form" method="post" action="/user2/join.nhn?m=begin" >
	<input type="hidden" id="token_sjoin" name="token_sjoin" value="p8AnbvqcylyCRnF2">
...
<div class="policy_summary">
				...
				<div class="btn_area double">
					<span><!-- tg-text=terms_button_cancel --><a href="#" onClick="submitDisagree();clickcr(this, 'tos.disagree', '', '', event);" class="btn_type btn_default">비동의</a></span>
					<span><!-- tg-text=terms_button_agree --><a href="#"  onClick="submitAgree();clickcr(this, 'tos.agree', '', '', event);" class="btn_type btn_primary">동의</a></span>
				</div>
								
</form>				
			<div class="group_join">
                회사, 동아리 등 단체에서 사용할 ID가 필요하세요? <a href="#" onClick="alert_ko_KR('/user2/join/groupJoin.nhn?lang=ko_KR');clickcr(this, 'smm.group', '', '', event);" class="btn_group_join">단체 회원 가입</a>
			</div>	
